...
var SubscriptionClient = (function () {
    ...
    SubscriptionClient.prototype.close = function (isForced, closedByUser) {
        ...
        if (this.client !== null) {
            ...
            Object.values(this.operations).forEach(function (op) {
    ...
    SubscriptionClient.prototype.connect = function () {
        var _a;
        var _this = this;
        this.client = new ((_a = this.wsImpl).bind.apply(_a, __spreadArray([void 0, this.url,
            this.wsProtocols], this.wsOptionArguments, false)))();
